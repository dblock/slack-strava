...
* 2026/08/02: Removed all club code (Club model, ClubActivity model, `/slava clubs` command, sync loop), data migration deletes existing club documents on startup - [@dblock](https://github.com/dblock), [@Copilot](https://github.com/apps/copilot-swe-agent).
