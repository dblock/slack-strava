...
* 2026/08/21: Upgraded ruby to 4.0.6 (Gemfile now matches the version already bumped by Renovate in workflows) - [@dblock](https://github.com/dblock), [@Copilot](https://github.com/apps/copilot-swe-agent).
