  ...
  shared_examples_for 'unsubscribe' do
    ...
    context 'with a plan' do
      ...
      context 'a customer' do
        ...
        it 'unsubscribes' do
          expect(message: "#{SlackRubyBot.config.user} unsubscribe #{active_subscription.id}", user: activated_user.user_name).to respond_with_slack_message 'Successfully canceled auto-renew for Plan ($29.99).'
          team.reload
