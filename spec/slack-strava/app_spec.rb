...
describe SlackStrava::App do
  ...
  context '#deactivate_asleep_teams!' do
    ...
    it 'destroys teams inactive for two weeks' do
      expect_any_instance_of(Team).to receive(:inform!).with(
        "This integration hasn't been used for 2 weeks, deactivating. Reactivate at #{SlackStrava::Service.url}. Your data will be purged in another 2 weeks."
      ).once
  ...
  context 'subscribed' do
    ...
    let(:plan) { stripe_helper.create_plan(id: 'slack-strava-yearly', amount: 2999) }
